...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Map data path ID -> data path.
        self.data_paths = {}

        # Map data path ID -> list of available ports.
        ...
        # Tenancy
        # Map group ID -> MAC addresses.
        self.groups = {}
        # Map MAC address -> belonged group.
        self.mac_to_group = {}

        # Leaf and host connection
        # Map MAC address -> connected leaf ID and port.
        self.mac_to_leaf = {}
        # Map Leaf ID -> port number -> MAC address.
        self.leaf_to_macs = {}
